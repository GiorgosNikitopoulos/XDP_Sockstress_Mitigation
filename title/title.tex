...
\includegraphics[width=5cm]{title/alterlogo.png}\\[1cm] % Include a department/university logo - this will require the graphicx package
...
\textsc{\Large University of Thessaly}\\[0.5cm] % Major heading such as course name
...
{\large A project report submitted for the class of}\\[0.5cm]
{\large \emph{HY401 Special Topics}}\\[0.5cm]
